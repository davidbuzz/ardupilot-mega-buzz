...
/*
 *       AP_ADC_PX4.cpp - ADC ADS7844 Library for Ardupilot Mega
...
void AP_ADC_PX4::read(uint32_t tnow)
{
    uint8_t ch;
...
// Constructors ////////////////////////////////////////////////////////////////
AP_ADC_PX4::AP_ADC_PX4()
{
}

// Public Methods //////////////////////////////////////////////////////////////
void AP_ADC_PX4::Init()
{
...
/* 
 ...
 /*        adc_tmp  = ADC_SPI_transfer(0) << 8;
    ...
    hal.scheduler->register_timer_process( AP_ADC_PX4::read );

}

// Read one channel value
float AP_ADC_PX4::Ch(uint8_t ch_num)
{
    uint16_t count;
    uint32_t sum;
...
bool AP_ADC_PX4::new_data_available(const uint8_t *channel_numbers)
{
    uint8_t i;
...
uint32_t AP_ADC_PX4::Ch6(const uint8_t *channel_numbers, float *result)
{
    uint16_t count[6];
    uint32_t sum[6];
    uint8_t i;
...
uint16_t AP_ADC_PX4::num_samples_available(const uint8_t *channel_numbers)
{
