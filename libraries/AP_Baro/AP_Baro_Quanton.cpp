...
// Public Methods //////////////////////////////////////////////////////////////
bool AP_Baro_Quanton::init(void)
{
    if (_baro_fd <= 0) {
...
// Read the sensor
uint8_t AP_Baro_Quanton::read(void)
{
...
void AP_Baro_Quanton::_accumulate(void)
{
...
float AP_Baro_Quanton::get_pressure() {
    return _pressure;
}

float AP_Baro_Quanton::get_temperature() {
    return _temperature;
}
