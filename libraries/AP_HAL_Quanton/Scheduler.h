...
#ifndef __AP_HAL_Quanton_SCHEDULER_H__
...
#define Quanton_SCHEDULER_MAX_TIMER_PROCS 8
...
class Quanton::QuantonScheduler : public AP_HAL::Scheduler {
public:
    QuantonScheduler();
...
private:
    ...
    AP_HAL::MemberProc _timer_proc[Quanton_SCHEDULER_MAX_TIMER_PROCS];
    uint8_t _num_timer_procs;
    volatile bool _in_timer_proc;

    AP_HAL::MemberProc _io_proc[Quanton_SCHEDULER_MAX_TIMER_PROCS];
...
#endif
#endif // __AP_HAL_Quanton_SCHEDULER_H__
