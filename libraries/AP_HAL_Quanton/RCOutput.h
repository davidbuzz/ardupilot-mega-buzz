...
#ifndef __AP_HAL_Quanton_RCOUTPUT_H__
#define __AP_HAL_Quanton_RCOUTPUT_H__
...
private:
    ...
    int _alt_fd;
    uint16_t _freq_hz;
    uint16_t _period[Quanton_NUM_OUTPUT_CHANNELS];
...
#endif // __AP_HAL_Quanton_RCOUTPUT_H__
