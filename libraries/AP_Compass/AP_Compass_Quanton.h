...
#ifndef AP_Compass_Quanton_H
#define AP_Compass_Quanton_H

#include "Compass.h"

class AP_Compass_Quanton : public Compass
{
public:
    AP_Compass_Quanton() : Compass() {
        product_id = AP_COMPASS_TYPE_QUANTON; 
        _num_instances = 0;
    }
    bool        init(void);
    bool        read(void);
