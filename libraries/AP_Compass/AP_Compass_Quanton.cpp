...
/*
 *       AP_Compass_Quanton.cpp - Arduino Library for Quanton magnetometer
 *
 */
...
bool AP_Compass_Quanton::init(void)
{
...
bool AP_Compass_Quanton::read(void)
{
...
void AP_Compass_Quanton::accumulate(void)
{
...
uint8_t AP_Compass_Quanton::_get_primary(void) const
{
    for (uint8_t i=0; i<_num_instances; i++) {
