...
#define MAVLINK_CORE_HEADER_LEN 5 ///< Length of core header (of the comm. layer): message length (1 uint8_t) + message sequence (1 uint8_t) + message system id (1 uint8_t) + message component id (1 uint8_t) + message type id (1 uint8_t)
