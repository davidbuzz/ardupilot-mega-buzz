...
static void do_takeoff()
{
    ...
    //hal.uart0->printf_P(PSTR("TO pitch:"));	hal.uart0->println(takeoff_pitch);
    //hal.uart0->printf_P(PSTR("home.alt:"));	hal.uart0->println(home.alt);
    takeoff_altitude        = next_nav_command.alt;
    //hal.uart0->printf_P(PSTR("takeoff_altitude:"));	hal.uart0->println(takeoff_altitude);
